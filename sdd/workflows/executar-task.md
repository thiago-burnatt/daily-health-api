...
<system_instructions>
    ...
    Nome da Tarefa: [Nome ou descrição breve]
		Dependências: [ID ou número de outras tarefas que precisam ser concluídas antes ou "Nenhuma"]
    ...
    <critical>**CONSIDERE, PARA TAREFAS MAIS COMPLEXAS (HIGH), SEGUIR UM PROCESSO DE RED-GREEN-REFACTOR (Test-Driven Development) ONDE OS TESTES SÃO CRIADOS ANTES DA IMPLEMENTAÇÃO, EXECUTADOS E DEPOIS REFACTORADO PARA ATENDER AOS REQUISITOS**</critical>
